...
export const products = [
  // 1
  { id: 1, name: "Chakki Atta", category: "1", price: 180, oldPrice: 200, discount: 10, unit: "1 KG", image: img("1563636619-e9143da7973b"), description: "Fresh and pure milk. Good for health and strong bones.", stock: true, popular: true, featured: true, tags: ["fresh", "daily", "milk"] },
  { id: 2, name: "Fine Atta", category: "1", price: 180, oldPrice: 200, discount: 10, unit: "1 KG", image: img("1563636619-e9143da7973b"), description: "Fresh and pure milk. Good for health and strong bones.", stock: true, popular: true, featured: true, tags: ["fresh", "daily", "milk"] },
  ...
  { id: 6, name: "Basmati Rice", category: "1", price: 180, oldPrice: 200, discount: 10, unit: "1 KG", image: img("1563636619-e9143da7973b"), description: "Fresh and pure milk. Good for health and strong bones.", stock: true, popular: true, featured: true, tags: ["fresh", "daily", "milk"] },
  { id: 7, name: "Sella Rice", category: "1", price: 180, oldPrice: 200, discount: 10, unit: "1 KG", image: img("1563636619-e9143da7973b"), description: "Fresh and pure milk. Good for health and strong bones.", stock: true, popular: true, featured: true, tags: ["fresh", "daily", "milk"] },
  { id: 8, name: "Broken Rice", category: "1", price: 180, oldPrice: 200, discount: 10, unit: "1 KG", image: img("1563636619-e9143da7973b"), description: "Fresh and pure milk. Good for health and strong bones.", stock: true, popular: true, featured: true, tags: ["fresh", "daily", "milk"] },
  ...
  // Daalain & Pulses
  { id: 11, name: "Masoor Daal", category: "2", price: 120, oldPrice: 140, discount: 14, unit: "Loaf", image: img("1509440159596-0249088772ff"), description: "Soft and fresh white bread baked daily.", stock: true, popular: true, featured: true, tags: ["bread", "2", "fresh"] },
  { id: 12, name: "Moong Daal", category: "2", price: 120, oldPrice: 140, discount: 14, unit: "Loaf", image: img("1509440159596-0249088772ff"), description: "Soft and fresh white bread baked daily.", stock: true, popular: true, featured: true, tags: ["bread", "2", "fresh"] },
  { id: 13, name: "Chana Daal", category: "2", price: 120, oldPrice: 140, discount: 14, unit: "Loaf", image: img("1509440159596-0249088772ff"), description: "Soft and fresh white bread baked daily.", stock: true, popular: true, featured: true, tags: ["bread", "2", "fresh"] },
  { id: 14, name: "Mash Daal", category: "2", price: 120, oldPrice: 140, discount: 14, unit: "Loaf", image: img("1509440159596-0249088772ff"), description: "Soft and fresh white bread baked daily.", stock: true, popular: true, featured: true, tags: ["bread", "2", "fresh"] },
  ...
  // Masalay & Namak
  { id: 19, name: "Lal Mirch Powder", category: "3", price: 220, oldPrice: 250, discount: 12, unit: "1 Liter", image: img("1600271886742-f98f9d7c0a0e"), description: "100%.", stock: true, popular: true, featured: true, tags: ["juice"] },
  { id: 20, name: "Haldi", category: "3", price: 220, oldPrice: 250, discount: 12, unit: "1 Liter", image: img("1600271886742-f98f9d7c0a0e"), description: "100%.", stock: true, popular: true, featured: true, tags: ["juice"] },
  ...
  // Breakfast
  { id: 32, name: "Egg", category: "5", price: 380, oldPrice: 420, discount: 10, unit: "500g", image: img("1615485920500-0a0a0a0a0a0a"), description: "Crispy corn flakes cereal for breakfast.", stock: true, popular: true, featured: true, tags: ["cereal", "breakfast"] },
];
